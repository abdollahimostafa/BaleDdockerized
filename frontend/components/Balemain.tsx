...
import {  Eye, Stethoscope, Microscope, CalendarDays, Syringe } from "lucide-react"
  ...
  return (
    <div className="h-full">
      <div className=" p-6 pb-5 xl:px-30 xl:pr-60 xl:pl-60 min-h-60 bg-[#2b7fff] rounded-b-4xl shadow-sm relative overflow-hidden text-white">
        ...
        >
          <h1 className="text-3xl text-center md:text-4xl font-bold">دریافت خدمات درمانی</h1>
          <p className="text-center mt-2 text-sm md:text-base text-white/90">
            دسترسی سریع به پزشک، آزمایشگاه و خدمات پزشکی
          </p>
          <div className="bg-white/20 backdrop-blur-xl px-4 py-1 rounded-2xl text-xs font-light mt-3 border border-white/10">
            بهترین خدمات درمانی آنلاین
          </div>
        </motion.div>
  <Image
    src="/logos.png"
